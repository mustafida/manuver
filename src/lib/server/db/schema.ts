...
export const manuver = mysqlTable('manuver', {
	...
	ulpAsal: varchar('ulp_asal', { length: 255 }),
	ulpTujuan: varchar('ulp_tujuan', { length: 255 }),
	...
	sectionAsalPenormalan: varchar('section_asal_penormalan', { length: 255 }),
	sectionTujuanPenormalan: varchar('section_tujuan_penormalan', { length: 255 }),
	pelaksanaanAsalPenormalan: varchar('pelaksanaan_asal_penormalan', { length: 255 }),
	pelaksanaanTujuanPenormalan: varchar('pelaksanaan_tujuan_penormalan', { length: 255 }),
