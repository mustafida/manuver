...
<div class="max-w-7xl mx-auto space-y-8 animate-in fade-in duration-500 pb-12">
	...
	<header class="flex items-center justify-between">
		<div class="flex items-center gap-4">
			...
			<div>
				<h1 class="text-3xl font-black text-slate-900 tracking-tight">Input Manuver</h1>
				<p class="text-slate-500 font-medium">Input data manuver jaringan terbaru</p>
			</div>
		</div>
	</header>
			...
			<div class="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-8 relative z-10">
				...
				<div class="md:col-span-2 bg-indigo-50/50 p-6 rounded-[2rem] border border-indigo-100/50 space-y-6">
					...
					<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
						<div class="space-y-2">
							...
							<input type="text" id="sectionAsal" name="sectionAsal" required placeholder="Titik Section Asal..." class="w-full bg-white border-transparent rounded-2xl px-6 py-4 shadow-sm focus:border-[#00A2E9] focus:ring-4 focus:ring-[#00A2E9]/10 transition-all font-bold text-slate-700" />
						</div>
						<div class="space-y-2">
				...
				<div class="space-y-4 md:col-span-2 bg-slate-50/50 p-6 rounded-[2rem] border border-slate-100">
					...
					<div class="space-y-2">
						...
						<textarea id="keterangan" name="keterangan" required rows="3" placeholder="Masukan keterangan detail jika diperlukan..." class="w-full bg-white border-transparent rounded-3xl px-6 py-4 shadow-sm focus:border-[#00A2E9] focus:ring-4 focus:ring-[#00A2E9]/10 transition-all font-bold text-slate-700 min-h-[100px]"></textarea>
					</div>
				</div>
			</div>
